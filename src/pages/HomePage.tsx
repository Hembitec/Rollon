  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section id="testimonials" className="w-full py-16 md:py-24 bg-slate-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">What Our Users Say</h2>
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl">
                  Discover how Rollon is transforming the learning experience for students and educators
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="flex flex-col p-6 space-y-4 bg-white rounded-lg shadow-sm">
                <div className="flex items-center space-x-2">
                  <div className="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center">
                    <span className="font-medium text-slate-600">JS</span>
                  </div>
                  <div>
                ...
                <p className="text-muted-foreground">
                  "Rollon has completely transformed how I study for my medical exams. I upload my lecture notes and
                  instantly get quizzes that help me identify knowledge gaps. It's saved me countless hours!"
                </p>
              ...
              <div className="flex flex-col p-6 space-y-4 bg-white rounded-lg shadow-sm">
                <div className="flex items-center space-x-2">
                  <div className="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center">
                    <span className="font-medium text-slate-600">MT</span>
                  </div>
                  <div>
                ...
                <p className="text-muted-foreground">
                  "As a teacher, Rollon has been a game-changer for creating assessments. I can quickly generate quizzes
                  from my lesson plans, saving me hours of work each week. My students love the variety of questions too!"
                </p>
                <div className="flex text-amber-500">
                  {Array(5)
                    .fill(null)
              ...
              <div className="flex flex-col p-6 space-y-4 bg-white rounded-lg shadow-sm">
                ...
                <p className="text-muted-foreground">
                  "I'm learning Spanish and Rollon helps me create vocabulary quizzes from my study materials. The AI is
                  smart enough to generate questions that really test my understanding, not just memorization."
                </p>
                <div className="flex text-amber-500">
                  {Array(5)
                    .fill(null)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-4xl mx-auto">
              <div className="flex flex-col p-6 bg-white rounded-lg shadow-sm border">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">Perfect for trying out Rollon</p>
              ...
              <div className="flex flex-col p-6 bg-white border-2 border-blue-500 rounded-lg shadow-sm relative">
                ...
                <ul className="mt-6 space-y-2">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                    <span>File uploads & URL imports</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                ...
                <Button className="mt-6 bg-blue-500 hover:bg-blue-600">Get Started</Button>
              </div>
            </div>
          </div>
        </section>
